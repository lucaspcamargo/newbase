...
#include <newbase/sys/audio/producer/looper.hpp>
#include <newbase/sys/audio/producer/vorbis.hpp>
#include <newbase/sys/audio/producer/generators.hpp>
#include <newbase/sys/audio/graph/graph.hpp>
#include <newbase/sys/audio/graph/nodes.hpp>
