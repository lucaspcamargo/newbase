...
//        the value is moved into the box
// owner: optional shared_ptr to keep an external object alive (e.g. systems)
//        this shared_ptr is also moved into the box
void push_meta_any(lua_State *L, entt::meta_any &&value, std::shared_ptr<void> &&owner = {nullptr});
